...
textround(elpos[3,], 0.03, lab = "BAMFILE", box.col = "grey70", shadow.col = "grey10", shadow.size = 0.005, cex = 1)
textrect(elpos[8,], 0.06, 0.03,lab = "make\nChrTable", box.col = "white", shadow.col = "grey10", shadow.size = 0.005, cex = 0.75)
textrect(elpos[6,], 0.06, 0.03,lab = "strandSeq\nFreqTable", box.col = "white", shadow.col = "grey10", shadow.size = 0.005, cex = 0.75)
textrect(elpos[10,], 0.06, 0.03,lab = "preprocess\nStrandTable", box.col = "white", shadow.col = "grey10", shadow.size = 0.005, cex = 0.75)
textrect(elpos[14,], 0.06, 0.03,lab = "cluster\nContigs", box.col = "white", shadow.col = "grey10", shadow.size = 0.005, cex = 0.75)
textrect(elpos[18,], 0.06, 0.03,lab = "reorient\nLinkageGroups", box.col = "white", shadow.col = "grey10", shadow.size = 0.005, cex = 0.75)
textrect(elpos[19,], 0.06, 0.03,lab = "merge\nLinkageGroup", box.col = "white", shadow.col = "grey10", shadow.size = 0.005, cex = 0.75)
textrect(elpos[23,], 0.06, 0.03,lab = "orderAll\nLinkageGroups", box.col = "white", shadow.col = "grey10", shadow.size = 0.005, cex = 0.75)
textround(elpos[27,], 0.03, lab = "writeBed", box.col = "grey70", shadow.col = "grey10", shadow.size = 0.005, cex = 1)

texthexa(elpos[7,], 0.06, 0.03,lab = "ideogram\nPlot", box.col = "lightblue", shadow.col = "grey10", shadow.size = 0.005, cex = 0.75)
texthexa(elpos[11,], 0.06, 0.03,lab = "make\nBoxPlot", box.col = "lightblue", shadow.col = "grey10", shadow.size = 0.005, cex = 0.75)
texthexa(elpos[5,], 0.06, 0.03,lab = "plotWC\ndistribution", box.col = "lightblue", shadow.col = "grey10", shadow.size = 0.005, cex = 0.75)
texthexa(elpos[15,], 0.06, 0.03,lab = "plotLG\ndistances", box.col = "lightblue", shadow.col = "grey10", shadow.size = 0.005, cex = 0.75)
texthexa(elpos[20,], 0.06, 0.03,lab = "barplot\nLGCalls", box.col = "lightblue", shadow.col = "grey10", shadow.size = 0.005, cex = 0.75)
texthexa(elpos[24,], 0.06, 0.03,lab = "plotContig\nOrder", box.col = "lightblue", shadow.col = "grey10", shadow.size = 0.005, cex = 0.75)
