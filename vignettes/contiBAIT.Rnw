...
<<strandSeqFreqTableExamplec, include=FALSE>>=
...
textrect(elpos[4,], 0.06, 0.03,lab = "makeChrTable", box.col = "white", shadow.col = "grey10", shadow.size = 0.005, cex = 0.75)
textrect(elpos[9,], 0.06, 0.03,lab = "divideMyChr", box.col = "white", shadow.col = "grey10", shadow.size = 0.005, cex = 0.75)
textrect(elpos[8,], 0.06, 0.03,lab = "strandSeq\nFreqTable", box.col = "white", shadow.col = "grey10", shadow.size = 0.005, cex = 0.75)
textrect(elpos[13,], 0.06, 0.03,lab = "preprocess\nStrandTable", box.col = "white", shadow.col = "grey10", shadow.size = 0.005, cex = 0.75)
textrect(elpos[18,], 0.06, 0.03,lab = "cluster\nContigs", box.col = "white", shadow.col = "grey10", shadow.size = 0.005, cex = 0.75)
textrect(elpos[23,], 0.06, 0.03,lab = "reorient\nLinkageGroups", box.col = "white", shadow.col = "grey10", shadow.size = 0.005, cex = 0.75)
textrect(elpos[28,], 0.06, 0.03,lab = "merge\nLinkageGroup", box.col = "white", shadow.col = "grey10", shadow.size = 0.005, cex = 0.75)
textrect(elpos[33,], 0.06, 0.03,lab = "orderAll\nLinkageGroups", box.col = "white", shadow.col = "grey10", shadow.size = 0.005, cex = 0.75)
textround(elpos[38,], 0.03, lab = "writeBed", box.col = "grey70", shadow.col = "grey10", shadow.size = 0.005, cex = 1)

texthexa(elpos[14,], 0.06, 0.03,lab = "make\nBoxPlot", box.col = "lightblue", shadow.col = "grey10", shadow.size = 0.005, cex = 0.75)
texthexa(elpos[7,], 0.06, 0.03,lab = "plotWC\nDistribution", box.col = "lightblue", shadow.col = "grey10", shadow.size = 0.005, cex = 0.75)
texthexa(elpos[19,], 0.06, 0.03,lab = "plotLG\nDistances", box.col = "lightblue", shadow.col = "grey10", shadow.size = 0.005, cex = 0.75)
texthexa(elpos[30,], 0.06, 0.03,lab = "barplotLinkage\nGroupCalls", box.col = "lightblue", shadow.col = "grey10", shadow.size = 0.005, cex = 0.75)

@

\begin{figure}
\begin{center}
<<label=fig1,fig=TRUE,echo=FALSE,width=6,height=8=>>=
<<fig1plot>>
@
