...
<<writeBedExample, eval=FALSE, echo=TRUE, fig=FALSE>>=
...
fromto <- matrix(ncol = 2, byrow = TRUE, data = c(
 ...
 for (i in 1:nr)
arrpos[i, ] <- straightarrow (to = elpos[fromto[i, 2], ], from = elpos[fromto[i, 1], ], lwd = 2, arr.pos = 0.6, arr.width=0.1, arr.length = 0.5)

textround(elpos[2,], 0.04, lab = "BAMFILE", box.col = "grey70", shadow.col = "grey10", shadow.size = 0.005, cex = 0.8)
textrect(elpos[3,], 0.09, 0.04,lab = "makeChr\nTable", box.col = "white", shadow.col = "grey10", shadow.size = 0.005, cex = 0.7)
textrect(elpos[7,], 0.09, 0.04,lab = "divide\nMyChr", box.col = "white", shadow.col = "grey10", shadow.size = 0.005, cex = 0.7)
...
textrect(elpos[22,], 0.09, 0.04,lab = "merge\nLinkageGroup", box.col = "white", shadow.col = "grey10", shadow.size = 0.005, cex = 0.7)
textrect(elpos[26,], 0.09, 0.04,lab = "orderAll\nLinkageGroups", box.col = "white", shadow.col = "grey10", shadow.size = 0.005, cex = 0.7)
textround(elpos[30,], 0.04, lab = "writeBed", box.col = "grey70", shadow.col = "grey10", shadow.size = 0.005, cex = 0.8)
...
texthexa(elpos[24,], 0.09, 0.04,lab = "barplotLinkage\nGroupCalls", box.col = "lightblue", shadow.col = "grey10", shadow.size = 0.005, cex = 0.7)
