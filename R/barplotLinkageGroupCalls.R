...
barplotLinkageGroupCalls.func <- function(object, assemblyBED, by='lg', returnTable=FALSE, saveFile=FALSE,  ...)
{
	...
	linkage.chr <- lapply(object, function(x){as.character(assemblyBED[x, colnames(assemblyBED[1])])})
	...
	chr.table <- computeBarPlotMatrix(object, assemblyBED)
...
#' Note that the rownames of assemblyBED should be the contig names, as they are used in object. 
